...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pasien', function (Blueprint $table) {
            ...
            $table->string('pekerjaan')->nullable(); // Assuming 'Pekerjaan' refers to a string field for the job title
            $table->string('nomor_telepon')->nullable(); // Assuming 'Nomor Telepon' refers to a string field for the phone number
