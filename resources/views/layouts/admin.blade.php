...
<head>
    ...
    <title>Health Accupunture - @yield('title')</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Healthy Accupunture</div>
            </a>
            ...
            <li class="{{ request()->routeIs('admin.data.pasien') ? 'nav-item active' : 'nav-item' }}">
                <a class="nav-link" href="{{ route('admin.data.pasien') }}">
                    <i class="fa-solid fa-hospital-user"></i>
                    <span>Data Pasien</span></a>
            </li>

            <li class="{{ request()->routeIs('admin.data.jadwal.akupuntur') ? 'nav-item active' : 'nav-item' }}">
                <a class="nav-link" href="{{ route('admin.data.jadwal.akupuntur') }}">
                    <i class="fa-solid fa-calendar-circle-user"></i>
                    <span>Data Jadwal Akupuntur</span></a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Healthy Accupunture Admin 2024 by 216151001</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ route('admin.logout.submit') }}">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ url('asstes-admin/js/demo/chart-pie-demo.js') }}"></script>
